...
CATEGORIES: list[dict] = [
    ...
    {"major": "ビジネス、経済とお金", "minor": "企業法務、知的財産",          "cid": "2078297805"},
    {"major": "職業とキャリア",       "minor": "仕事効率化・ノウハウ",        "cid": "2078297897"},  # 旧「仕事効率化、ノウハウ」は統合、親カテゴリで代替
    {"major": "職業とキャリア",       "minor": "労働問題、働き方",           "cid": "2078297899"},
    # ジャンル②: フリーランス・個人事業主の事務作業
    {"major": "ビジネス、経済とお金", "minor": "税金、年金",                "cid": "2080401772"},
    {"major": "ビジネス、経済とお金", "minor": "保険",                     "cid": "2080401781"},
    {"major": "ビジネス、経済とお金", "minor": "インターネットビジネス、SOHO", "cid": "2078297802"},
    {"major": "暮らしと生活ガイド",   "minor": "法律、消費者問題",           "cid": "2078297944"},
    # ジャンル③: 中小企業のIT・DX
    {"major": "コンピュータテクノロジー", "minor": "プログラミング",          "cid": "2078297622"},
    {"major": "スマートデバイス、PC、家電", "minor": "パソコン",             "cid": "2080401529"},
    {"major": "インターネット、通信",  "minor": "インターネットサービス",      "cid": "2080401307"},  # 旧「サービス、探しています」相当
]
